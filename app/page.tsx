  ...
  return (
    <div className="min-h-screen bg-[#0038FF] dark:bg-[#09090B] text-white selection:bg-[#CCFF00] selection:text-black transition-colors duration-300">
      ...
      {/* ═══════════════════════════════════
          ...
          ═══════════════════════════════════ */}
      <section className="relative z-10 border-t border-white/15 dark:border-white/10 bg-[#0038FF] dark:bg-[#0C1222] py-12 px-6 md:px-10 overflow-hidden transition-colors">
          ...
          <div className="flex gap-4 overflow-x-auto pb-4 scrollbar-none">
            {curriculum.phases.map((phase) => (
              <a
                key={phase.id}
                href="/curriculum"
                className="flex-shrink-0 w-64 bg-[#0C101D]/80 backdrop-blur-xl border border-white/20 dark:border-white/10 rounded-2xl p-5 hover:bg-white/15 dark:hover:bg-[#0038FF]/[0.05] hover:border-[#CCFF00]/50 dark:hover:border-[#00D4FF]/40 transition-all duration-300 group shadow-lg"
              >
                <div className="flex items-center justify-between mb-3">
                  <span className="text-[10px] font-bold uppercase tracking-wider text-[#CCFF00] dark:text-indigo-400 bg-[#CCFF00]/15 dark:bg-indigo-500/10 px-2.5 py-1 rounded-full border border-[#CCFF00]/30 dark:border-indigo-500/30">
                    Phase 0{phase.order}
                  </span>
      ...
      {/* ═══════════════════════════════════
          CLOSING CTA SECTION
          ═══════════════════════════════════ */}
      <section className="relative z-10 border-t border-white/15 dark:border-white/10 bg-[#001A99] dark:bg-[#111a2e] py-20 px-6 text-center transition-colors">
